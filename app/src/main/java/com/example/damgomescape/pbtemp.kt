...
class pbtemp : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
                ...
                if (poker_count2 == 0) {
                    ...
                    if (dg_chip == 0) {
                        ...
                        do {
                            pb_betting_chip_var = temp_b
                            pb_number_of_chips = temp_n
                            pb_betting_chip_var += listOf(
                                (dg_betting - pb_betting + 4),
                                (dg_betting - pb_betting + 1)
                            ).random()
                            pb_number_of_chips -= pb_betting_chip_var - pb_betting
                        } while (pb_number_of_chips < 0 || ((pb_betting_chip_var - pb_betting) > dg_number_of_chips + dg_betting_chip_var - pb_number_of_chips))
                    } else if (pb_card == 10) {
                        ...
                        do {
                            ...
                            pb_number_of_chips = temp_n
                            pb_betting_chip_var += listOf(
                                (dg_betting - pb_betting + 2),
                                (dg_betting - pb_betting + 6)
                            ).random()
                            pb_number_of_chips -= pb_betting_chip_var - pb_betting
                        } while (pb_number_of_chips < 0 || ((pb_betting_chip_var - pb_betting) > dg_number_of_chips + dg_betting_chip_var - pb_number_of_chips))
                    } else if (pb_card == 9) {
            ...
            poker_next_button.setOnClickListener {
                ...
                if (poker_count == 2) {
                    ...
                    submit_button.setOnClickListener {
                        if (submit_point.text.toString().isEmpty()) {
                        ...
                        } else if (submit_point.text.toString()
                                .toInt() > pb_number_of_chips + pb_betting_chip_var - dg_betting_chip_var
                        ) {
                            as_script.text = "핑크빈님이 최소한 콜은 할 수 있게 베팅하셔야 합니다."
                        } else if (submit_point.text.toString()
                                .toInt() < (pb_betting_chip_var - dg_betting_chip_var)
                        ) {
                            ...
                            poker_next_button3.setOnClickListener {
                                ...
                                if (poker_count4 == 1) {
                                    if (dg_card_value == pb_card_value) {
                                        as_script.text =
                                            "아 같은 카드가 나왔군요! 이러면 베팅된 칩을 그대로 두고 다음 라운드로 갑니다."
                                        poker_next_button.visibility = View.VISIBLE
                                        poker_next_button3.visibility = View.INVISIBLE
                                        poker_count = 1
                                        card_index += 2
                            ...
                            poker_pb_action(
                                ...
                                dg_number_of_chips,
                                pb_number_of_chips,
                                card_array[card_index],
                                card_array[card_index + 1],
                                dg_betting_chip_var,
                                pb_betting_chip_var
                            )
                            poker_next_button.visibility = View.VISIBLE
        ...
        fun point_120() {
            ...
            var p_round6_point =
                120 - (p_round1_point + p_round2_point + p_round3_point + p_round4_point + p_round5_point + p_round7_point)
                ...
                if (count_120 == 3) {
                    ...
                    if (submit_point.text.toString().toInt() == p_round1_point) {
                        ...
                        point_120_next_button2.setOnClickListener {
                            if (count_120_2 == 0) {
                                pb_script.text =
                                    "호오~ 나랑 똑같이 ${submit_point.text.toString().toInt()}를 쓰다니"
                            }
                            if (count_120_2 == 1) {
